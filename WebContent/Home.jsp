				...
				<div class="wrapper">
			        ...
			        while (iterator.hasNext()) {
			            ...
			            <figure class="card">
			            	...
			            	<figcaption>
								<div>
									<strong> <% out.print(jo.get("model")); %> </strong><br><% out.print(jo.get("rentPrice")); %>EUR<br>NOTE: <% out.print(jo.get("noteCar")); %>/20<br>CLEANLINESS NOTE: <% out.print(jo.get("noteCarCleanliness")); %>/20
								</div>
								<div class="special-div">
									<form action="${pageContext.request.contextPath}/addToCart"
										...
										<button type="submit" name="shopButton" value="<%out.print(jo.get("id"));%>" 
											...
											if(app.isInCart((Long)jo.get("id"))) out.print("disabled"); 
											if(app.isCurrentlyRented((Long)jo.get("id"))) out.print("disabled"); 
											%>>
											<strong>Rent</strong>
										</button>
									</form>
